...
void Connection::addObjectManager(const std::string& objectPath, sd_bus_slot** handle)
{
...
void Connection::removeObjectManager(sd_bus_slot* handle)
{
    iface_->sd_bus_slot_unref(handle);
}
